              ...
              <div className="cards">
                  <img src={magicBanner} alt="" />
                    <div className="project-explanation">
                      ...
                      <li>Showcases use of routing, state, dependency injection, and pipes in Angular</li>
                    </div>
                    <div className="button-container">
                    <a href="https://oldephraim.github.io/Magic-The-Gathering" target="_blank" rel="noreferrer"><button>See Project</button></a>
                    <a href="https://github.com/OldEphraim/Magic-The-Gathering" target="_blank" rel="noreferrer"><button>See GitHub</button></a>
                    <a href="https://oldephraimlearnstocode.wordpress.com/2022/06/06/magic-the-gathering-card-lookup-site-code-review/" target="_blank" rel="noreferrer"><button>See Blogpost</button></a>
                  </div>
                </div>
                <div className="cards">
                ...
                <div className="cards">
                    ...
                    <div className="button-container">
                    <a href="https://oldephraim.github.io/Angular-Weather-App" target="_blank" rel="noreferrer"><button>See Project</button></a>
                    <a href="https://github.com/OldEphraim/Angular-Weather-App" target="_blank" rel="noreferrer"><button>See GitHub</button></a>
                    <a href="https://oldephraimlearnstocode.wordpress.com/2022/06/03/weather-app-code-review/" target="_blank" rel="noreferrer"><button>See Blogpost</button></a>
                    </div>
                </div>
                <div className="cards">
                   <img src={wordle} alt="" />
